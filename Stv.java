...
public final class Stv {
	...
	private void transferirVoto(Map<Integer, ArrayList<Voto>> votosPorSiguienteOpcion,Integer candidatoAQuitarVoto, Integer candidatoAPonerVoto) {
    ...
    public Map<Integer, ArrayList<Voto>> getVotosPorCandidato() {
        return votosPorCandidato;
    }

    public void setVotosPorCandidato(Map<Integer, ArrayList<Voto>> votosPorCandidato) {
